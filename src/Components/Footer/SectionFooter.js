                ...
                <div className='content-narrow'>
                    <div className='footer-content'>
                        <div className='footer-left'>
                            <div>
                                <img src="https://assets.website-files.com/62d52b6d074c2e318f479724/62dd6dd90df0882eb716b540_adc-white.svg" loading="lazy" alt="AdCreative AI Logo" class="footer-lofo inline" />
                                ...
                                <p class="is-soft-purple bottom-margin-20">
                                    ...
                                    Reach us at:
                                    <strong> contact@adcreative.ai</strong>
                                </p>
                            </div>
                        </div>
