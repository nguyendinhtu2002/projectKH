...
export const report = (reportOrder) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(
            'https://up-views.herokuapp.com/api/report',
            reportOrder,
            config)
...
export const listMyMessage = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`https://up-views.herokuapp.com/api/report/getByUser`, config);
...
export const messagelistDetailMessage = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`https://up-views.herokuapp.com/api/report/${id}`, config);
