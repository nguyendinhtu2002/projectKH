    ...
    return (
        <>
            ...
            <div className='card-body py-5'>
                <div className='flex flex-wrap items-center  gap-2'>
                    <div className='flex items-center mr-10 flex-grow'>
                        ...
                        <div className='m-0'>
                            ...
                            <span class="font-bold text-gray-800 text-[1.075rem]">https://www.facebook.com/azview.me/</span>
                        </div>
                    </div>
                    <div className='flex items-center mr-10 flex-grow'>
                        <div className='flex items-center mr-10 flex-grow'>
                ...
                <div className='flex items-center flex-wrap gap-2 border-t-2 border-gray-300 mt-5 pt-5'>
                    <p>Support payment :</p>
                    <ul >
                        <li>
                        WhatsApp : +84917557227
                        </li>
                    </ul>
                </div>
            </div>
