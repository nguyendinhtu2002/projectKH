...
function AddFund() {
    const getMoneyByUser = useSelector((state) => state.getMoneyByUser)
    const { cashFlow } = getMoneyByUser
    const tempt = cashFlow?.map((items) =>  items.spending )
    return (
        <>
                                ...
                                <div className='flex flex-wrap'>
                                    <div className='border border-gray-300 border-dashed rounded-[0.65rem] min-w-[125px] py-3 px-4 mr-6 mb-3'>
                                        <div className='flex items-center'>
                                            ...
                                            <div class="text-xl font-semibold text-[#50cd89] " >${<CountUp start={0} end={tempt?.reduce(function(a, b) { return a + b; }, 0)/23000} decimal className="text-[#50cd89] min-w-[70px] " formattingFn={num => num.toLocaleString() } />}</div>
                                        </div>
                                    ...
                                    <div className='border border-gray-300 border-dashed rounded-[0.65rem] min-w-[125px] py-3 px-4 mr-6 mb-3'>
                                        <div className='flex items-center'>
                                            ...
                                            <div class="text-xl font-semibold text-[#ffc700] " >${<CountUp start={0}  end={0} />}</div>
                                        </div>
